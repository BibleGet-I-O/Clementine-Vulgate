...
# sed script to generate part of the body of an XHTML 1.0 document from VulSearch
# Latin source files. An accompanying Perl script, makehtml.pl, uses the output
# from the current script to make a complete valid XHTML 1.0 document.
# Requirements: sed
# 
...
# including a description of the source format (see also comments below).
